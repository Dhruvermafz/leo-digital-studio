...
(function (window, document, $, undefined) {
  ...
  $.extend(FancyBox.prototype, {
    ...
    jumpTo: function (pos, duration, slide) {
      ...
      transitionProps =
        "fancybox-slide--" + (previous.pos > current.pos ? "next" : "previous");
    ...
    getFitPos: function (slide) {
      ...
      canvasWidth =
        parseInt(self.$refs.stage.width(), 10) - (margin[1] + margin[3]);
      canvasHeight =
        parseInt(self.$refs.stage.height(), 10) - (margin[0] + margin[2]);
    ...
    focus: function (duration) {
      ...
      if (self.instance.current) {
        ...
        if (
          ...
          $list
            .stop()
            .animate({ scrollTop: $list.scrollTop() + thumbPos.top }, duration);
        } else if (
          self.opts.axis === "x" &&
  ...
  $(document).on("click", "[data-fancybox-share]", function () {
    ...
    if (f) {
      ...
      tpl = f.current.opts.share.tpl
        .replace(
          /\{\{media\}\}/g,
          f.current.type === "image" ? encodeURIComponent(f.current.src) : ""
        )
        ...
        if (gallery && gallery !== "") {
          ...
          if ("replaceState" in window.history) {
            ...
            timerID = setTimeout(function () {
              window.history[
                shouldCreateHistory ? "pushState" : "replaceState"
              ](
                {},
                document.title,
