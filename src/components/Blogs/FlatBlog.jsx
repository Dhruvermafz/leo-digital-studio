                ...
                <div className="wrap-pagination">
                    <div className="themesflat-pagination clearfix">
                        <ul className="flex-three">
                            <li className="style-left"><a href="#" className="page-numbers style style1"><i className="far fa-angle-left"></i></a></li>
                            <li><a href="#" className="page-numbers numbers current"></a></li>
                            <li><a href="#" className="page-numbers numbers "></a></li>
                            <li><a href="#" className="page-numbers numbers"></a></li>
                            <li><a href="#" className="page-numbers numbers"></a></li>
                            <li><a href="#" className="page-numbers numbers"></a></li>
                            <li className="style-right"><a href="#" className="page-numbers style "><i className="far fa-angle-right"></i></a></li>
                        </ul>
                    </div> 
                </div>
            </div>
