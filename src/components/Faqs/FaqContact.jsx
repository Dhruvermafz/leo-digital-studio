                                    ...
                                    <form onSubmit={handleSubmit} method="post" id="contactform" className="comment-form form-submit"
                                        ...
                                        <div className="text-wrap clearfix flex">
                                            <fieldset className="text-box name-wrap">
                                                <input type="text" id="name" className="tb-my-input" name="name"
                                                    tabIndex="1" placeholder="Full Name" value={formData.name} onChange={handleChange} size="32"
                                                    aria-required="true" required="" />
                                            </fieldset>
                                            <fieldset className="text-box phone-wrap">
                                                <input type="tel" id="tel" className="tb-my-input" name="phone"
                                                    tabIndex="1" placeholder="Phone Number" value={formData.phone} onChange={handleChange} size="32"
                                                    aria-required="true" required="" pattern="^[\d\+\s\(\)]{7,20}$" />
                                            </fieldset>
                                            <fieldset className="text-box email-wrap">
                                                <input type="email" id="email" className="tb-my-input" name="email"
                                                    tabIndex="2" placeholder="Email Address" value={formData.email} onChange={handleChange} size="32"
                                                    aria-required="true" required="" />
                                            </fieldset>
                                        </div>
                                        <fieldset className="message-wrap">
                                            <textarea id="comment-message" name="message" rows="4" tabIndex="5"
                                                ...
                                                aria-required="true" value={formData.message} onChange={handleChange}></textarea>
                                        </fieldset>
                                        <div className="button-box center">
                                            <button id="submit" name="submit" type="submit" className="cta btn-5" disabled={loading}>
                                                <span>{loading ? 'Submitting...' : 'Send Us Message'}</span>
                                                <span>
