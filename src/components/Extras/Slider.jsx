...
const Slider = () => {
  return (
            ...
            <div class="flat-slider">
              <div class="container flex">
                <div class="content po-content-two">
                  ...
                  <div class="flat-bt-slider flex">
                    <div class="sc-btn-top">
                      <a class="cta btn-1" href="services.html">
                    ...
                    <div class="post-video flex-three">
                      <a
                      ...
                      >
                        ...
                        >
                          <path
                            d="M0.75 1.25L11.25 8L0.75 14.75V1.25Z"
                            stroke="#120A21"
                            stroke-width="1.5"
                      ...
                      <div class="title-16 fw-5 text-color-2">
                        Watch Video
                      </div>
                    </div>
                  </div>
                ...
                <div class="images po-content-one">
                  ...
                  <div class="mark-map absolute">
                    <img
                      class="img-item"
                      src="assets/images/slider/mark-slider-2.png"
                      alt=""
                    />
                  </div>
                </div>
    ...
    <div class="button-custom-slider">
      <div class="swiper-button-next3 button-slide-custom-next">
        <i class="far fa-angle-right"></i>
      </div>
      <div class="swiper-button-prev3 button-slide-custom-prev">
