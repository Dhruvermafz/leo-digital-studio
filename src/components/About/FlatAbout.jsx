...
const FlatAbout = () => {
  return (
    <section class="tf-section flat-about3">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-5">
          <div class="box-images">
            <div class="images">
              <img src="assets/images/img-box/about-2.png" alt="" />
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-7">
          <div class="about-box">
            <div class="heading-section style3">
              ...
              <h2>Digital Marketing Solutions For Growth Business</h2>
            </div>
            <div class="icon-box flex">
              <div class="inner inner-1 flex-three">
                <div class="icon">
                  <img src="assets/images/icon/icon-about-1.png" alt="" />
                </div>
                <h6 class="link-style-1">
                  <a href="about.html">Research & Strategy</a>
                </h6>
              </div>
              <div class="inner inner-2 flex-three">
                <div class="icon">
                  <img src="assets/images/icon/icon-about-2.png" alt="" />
                </div>
                <h6 class="link-style-1">
