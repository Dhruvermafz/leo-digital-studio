...
const Help = () => {
  ...
  return (
    ...
    <section className="flat-subscribe">
       
       <img className="mark-2 absolute" src={mark} alt=""/>
       <img className="mark-3 absolute" src={mark2} alt=""/>
       <img className="mark-4 absolute" src={mark3} alt=""/>
       <div className="container">
           <div className="row">                  
               <div className="col-lg-6 col-md-8">
                   <div className="wrap-subscribe">
                       <div className="heading-section style2">
                           <h6 className="">Our Newsletter</h6>
                           <h2 className="text-color-1">Get Every Single Updates Newsletter Subscribe</h2>                                  
                       </div>   
                       ...
                       <div className="icon-title flex-three">                                    
                           <p className="text-color-1">Get Every 7 Days Updates or Monthly updates</p></div>
                   </div>                                                 
               </div>
               <div className="col-lg-6 col-md-4">
                   <div className="images">
                       <img src={newsletter} alt=""/>
                       <div className="mark-img animate-zoom">
                           <img src={mark} alt=""/>
                       </div>
                   </div>
               </div>
